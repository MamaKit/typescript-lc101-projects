...
// console.log(`It will take the ${spacecraftName} spacecraft ${getDaysToLocation(kilometersToMars)} days to reach Mars, & ${getDaysToLocation(kilometersToTheMoon)} days to reach the Moon.`);
